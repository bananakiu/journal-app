class TasksController < ApplicationController
    ...
    def create
        ...
        if @task.save
            redirect_to category_tasks_path(@category), notice: "Successfully created a task!"
        else
            render :new
        end
    end
    ...
    def update
        if @task.update(task_params)
            # redirect_to @task
            redirect_to category_tasks_path(@category), notice: "Successfully updated task!"
        else
            render :edit
        end
    end
    ...
    def destroy
        @task.destroy
        redirect_to category_path(@category), notice: "Successfully deleted task!"
    end
